      ...
      >
        ...
        <div className={clsx(
          ...
          <div className={clsx(
            ...
            <ShieldCheck size={isOpen ? 20 : 24} />
          </div>
          <div className={clsx("flex flex-col ml-3 whitespace-nowrap transition-opacity duration-300", !isOpen && "opacity-0 hidden")}>
            <span className="font-bold text-[15px] leading-tight text-foreground uppercase tracking-tight">Anle Logistics</span>
            <span className="text-[11px] text-muted-foreground leading-tight">Freight Forwarding CRM</span>
          </div>
        </div>
