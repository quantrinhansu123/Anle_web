      ...
      try {
        ...
        if (item) {
          ...
          const mapped: QuotationData = {
            ...
            etd: formatDate(item.etd || item.shipments?.etd),
            eta: formatDate(item.eta || item.shipments?.eta),
            vessel: item.vessel_voyage?.trim() || item.shipments?.vessel_voyage?.trim() || 'N/A',
            quoteDateIso,
