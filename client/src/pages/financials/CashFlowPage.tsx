...
import { CASH_FLOW_MOCK } from './cashFlowMock';
...
const CashFlowPage: React.FC = () => {
  ...
  const rows = useMemo(() => visibleRows(CASH_FLOW_MOCK, expanded), [expanded]);
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            ...
            <div className="flex flex-col gap-2 text-[11px] md:text-[12px] text-muted-foreground min-w-0 md:max-w-xl md:text-right md:items-end">
              ...
              <div className="inline-flex items-center gap-1.5">
                ...
                <span className="font-medium text-foreground/90">Report: Statement of cash flows (B03-DN)</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <table className="w-full border-collapse text-[13px] min-w-[560px]">
                ...
                <tbody>
                  {rows.map(({ node: n, depth }) => {
                    ...
                    const neg = n.balance !== null && n.balance < 0;
                    return (
                      <tr
                        key={n.id}
                        className={clsx(
                      ...
                      >
                        ...
                        <td
                          className={clsx(
                            ...
                            neg ? 'text-red-600 font-medium' : 'text-slate-800',
                          )}
                        >
                          {fmtMoney(n.balance)}
                        </td>
