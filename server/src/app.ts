...
import accountDictionaryRoutes from './modules/account-dictionary/account-dictionary.routes';
import generalJournalRoutes from './modules/general-journal/general-journal.routes';
...
app.use(`${v1}/account-dictionary`, departmentAccess('finance', 'bod'), accountDictionaryRoutes);
app.use(`${v1}/general-journal`, departmentAccess('finance', 'bod'), generalJournalRoutes);
